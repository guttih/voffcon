...
We will need to send the Device server program to the device.  We can do that by connected the device to your computer via usb cable.  But before sending the program you will need to change a fiew values.  
