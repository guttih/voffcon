...
function setStatusValues(statusData) {

    if (statusData.hostName !== undefined) {
        $('#tr-host-name').removeClass("hidden");
        $('#device-host-name').text(statusData.hostName);
    }
    if (statusData.macAddress !== undefined) {
        $('#tr-mac-address').removeClass("hidden");
        $('#device-mac-address').text(statusData.macAddress);
    }
}
